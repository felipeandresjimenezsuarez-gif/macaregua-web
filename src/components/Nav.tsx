    ...
    <nav className="sticky top-0 z-50 bg-[#0d0d0d]/95 backdrop-blur-sm border-b border-[#1e1e1e]">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <a
          ...
          className="animate-wa-bounce flex items-center gap-1.5 bg-[#25D366] text-white text-[12px] font-medium px-3 sm:px-5 py-2.5 min-h-[44px] rounded tracking-wide flex-shrink-0"
        >
