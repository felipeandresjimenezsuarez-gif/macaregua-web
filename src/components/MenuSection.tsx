...
const DESAYUNOS = [
  ...
  { name: 'Caldo de Res Especial',       price: '$30.000', base: 'Con bebida',  extras: ['Sin bebida −$3.000'],        img: '/images/hero-caldo-arepa.jpg' },
  { name: 'Caldo de Costilla',           price: '$33.000', base: 'Con bebida',  extras: ['Sin bebida −$3.000'],        img: '/images/hero-sancocho.jpg' },
  { name: 'Caldo con Huevo y Arepa',     price: '$18.000', base: 'Con bebida',  extras: ['Sin bebida −$2.000', '+ Queso +$2.000'], img: '/images/hero-caldo-arepa.jpg' },
  { name: 'Caldo de Pollo',              price: '$16.000', base: 'Con bebida',  extras: ['Sin bebida −$2.000', '+ Huevos +$3.000'], img: '/images/hero-caldo-arepa.jpg' },
...
const ACARTA = [
  { name: 'Chatas',                    price: '$42.000', base: 'Acompañamientos', extras: ['Arroz, papa a la francesa, ensalada'],  img: '/images/hero-bandeja-paisa.jpg' },
  ...
  { name: 'Pechuga a la Plancha',      price: '$30.000', base: 'Acompañamientos', extras: ['Arroz, papa a la francesa, ensalada'],  img: '/images/gallery-pollo-plancha.jpg' },
  { name: 'Pechuga Gratinada',         price: '$36.000', base: 'Acompañamientos', extras: ['Arroz, papa a la francesa, ensalada'],  img: '/images/hero-bandeja-paisa.jpg' },
  ...
  { name: 'Sobrebarriga',              price: '$36.000', base: 'Acompañamientos', extras: ['Arroz, papa a la francesa, ensalada'],  img: '/images/plato-bandeja.jpg' },
  { name: 'Mojarra Frita',             price: '$30.000', base: 'Acompañamientos', extras: ['Arroz, ensalada, papa o patacón'],       img: '/images/plato-almuerzo.jpg' },
  { name: 'Bagre Frito',               price: '$36.000', base: 'Acompañamientos', extras: ['Arroz, ensalada, papa o patacón'],       img: '/images/plato-bandeja.jpg' },
  { name: 'Bagre Sudado',              price: '$38.000', base: 'Acompañamientos', extras: ['Arroz, ensalada, papa o patacón'],       img: '/images/hero-cazuela.jpg' },
  { name: 'Cazuela Mariscos',          price: '$32.000', base: 'Acompañamientos', extras: ['Arroz, ensalada, papa o patacón'],       img: '/images/hero-cazuela.jpg' },
  { name: 'Lasagna Mixta',             price: '$30.000', base: 'Carne, pollo',    extras: ['Incluye acompañamientos'],               img: '/images/plato-bandeja.jpg' },
...
export default function MenuSection() {
  ...
  if (!mounted) {
        return <section id="menu" className="py-14 px-8 max-w-7xl mx-auto reveal"></section>section>
          }
          
            return (
                  <section id="menu" className="py-14 px-8 max-w-7xl mx-auto reveal">
                        <p className="eyebrow">Menú completo</p>p>
                        <h2 className="font-serif text-[32px] font-normal text-[#f0f0f0] leading-snug mb-2">¿Qué se te antoja?</h2>h2>
                        <p className="text-[13px] font-light text-[#444] mb-8">El menú cambia según la hora · Ordena directo por WhatsApp · IVA incluido</p>p>
                            ...
                            <div>
                                      <div className="flex gap-3 items-start bg-[#111] border border-[#1e1e1e] rounded p-4 mb-6">
                                                  ...
                                                  <p className="text-[12px] font-light text-[#555] leading-relaxed">
                                                                <span className="text-[#D4A017] font-normal">Precio base + extras al gusto.</span>span>{' '}
                                      ...
                                      <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#1a1a1a] rounded overflow-hidden">
                                        {DESAYUNOS.map((d) => (
                                            <div key={d.name} className="bg-[#0f0f0f] p-4 flex items-center gap-4 hover:bg-[#131313] transition-colors">
                                                            <div className="w-14 h-14 rounded flex-shrink-0 bg-[#222]"></div>div>
                                                            <div className="flex-1 min-w-0">
                                                                              <div className="font-serif text-[15px] font-normal text-[#ddd] mb-1 leading-snug">{d.name}</div>div>
                                                                              <div className="flex gap-1.5 flex-wrap mb-2">
                                                                                                  <span className="text-[10px] px-2 py-0.5 rounded-sm border border-[#D4A01730] bg-[#D4A01710] text-[#D4A017] tracking-wide">{d.base}</span>span>
                                                                                {d.extras.map((e) => (
                                                                    <span key={e} className="text-[10px] px-2 py-0.5 rounded-sm border border-[#2222228c] bg-[#111] text-[#555] tracking-wide">{e}</span>span>
                                                                  ))}
                                                                              </div>div>
                                                            </div>div>
                                                            <div className="text-right flex-shrink-0">
                                                                              <div className="font-serif text-[18px] font-light text-[#D4A017]">{d.price}</div>div>
                                                                              <a
                                                                                                    href={WA(d.name)}
                                                                                                    target="_blank"
                    ...
                    {active === 1 && (
                            <div>
                                      <div className="flex gap-3 items-start bg-[#111] border border-[#1e1e1e] rounded p-4 mb-6">
                                                  <div className="w-2 h-2 rounded-full bg-[#D4A017] mt-1 flex-shrink-0" />
                                                  <p className="text-[12px] font-light text-[#555] leading-relaxed">
                                                                <span className="text-[#D4A017] font-normal">Todos los platos incluyen acompañamientos.</span>span>{' '}
                              ...
                              {ALMUERZOS.map((p) => (
                                          <div
                                            ...
                                            {p.featured && (
                                                        ...
                                                        <div className="h-36 w-full bg-[#222]"></div>div>
                                                        <div className="p-5 pt-4">
                                                                        <h3 className="font-serif text-[19px] font-normal text-[#f0f0f0] mb-2 mt-2 leading-snug">{p.name}</h3>h3>
                                                                        <p className="text-[12px] font-light text-[#555] leading-relaxed mb-4">{p.desc}</p>p>
                                                                        <div className="font-serif text-[28px] font-light text-[#D4A017]">{p.price}</div>div>
                                                                        <div className="text-[9px] font-light text-[#333] tracking-widest mt-1 mb-4">IVA INCLUIDO</div>div>
                                                                        <a
                                                                                            href={WA(p.name)}
                                                                                            target="_blank"
                                                                                            rel="noopener noreferrer"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#1a1a1a] rounded overflow-hidden">
                              {PIZZAS.map((p) => (
                                          <div key={p.name} className="bg-[#0f0f0f] p-4 flex items-center gap-4 hover:bg-[#131313] transition-colors">
                                                        <div className="w-14 h-14 rounded flex-shrink-0 bg-[#222]"></div>div>
                                                        <div className="flex-1 min-w-0">
                                                                        <div className="font-serif text-[15px] font-normal text-[#ddd] mb-1 leading-snug">{p.name}</div>div>
                                                                        <div className="flex gap-1.5 flex-wrap mb-2">
                                                                                          <span className="text-[10px] px-2 py-0.5 rounded-sm border border-[#D4A01730] bg-[#D4A01710] text-[#D4A017] tracking-wide">{p.base}</span>span>
                                                                          {p.extras.map((e) => (
                                                                <span key={e} className="text-[10px] px-2 py-0.5 rounded-sm border border-[#2222228c] bg-[#111] text-[#555] tracking-wide">{e}</span>span>
                                                              ))}
                                                                        </div>div>
                                                        ...
                                                        <div className="text-right flex-shrink-0">
                                                                        <div className="font-serif text-[18px] font-light text-[#D4A017]">{p.price}</div>div>
                                                                        <a
                                                                                            href={WA(p.name)}
                                                                                            target="_blank"
                                                                                            rel="noopener noreferrer"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#1a1a1a] rounded overflow-hidden">
                              {BEBIDAS.map((b) => (
                                          <div key={b.name} className="bg-[#0f0f0f] p-4 flex items-center gap-4 hover:bg-[#131313] transition-colors">
                                                        <div className="w-14 h-14 rounded flex-shrink-0 bg-[#222]"></div>div>
                                                        <div className="flex-1 min-w-0">
                                                                        <div className="font-serif text-[15px] font-normal text-[#ddd] mb-1 leading-snug">{b.name}</div>div>
                                                                        <div className="flex gap-1.5 flex-wrap mb-2">
                                                                                          <span className="text-[10px] px-2 py-0.5 rounded-sm border border-[#D4A01730] bg-[#D4A01710] text-[#D4A017] tracking-wide">{b.base}</span>span>
                                                                          {b.extras.map((e) => (
                                                                <span key={e} className="text-[10px] px-2 py-0.5 rounded-sm border border-[#2222228c] bg-[#111] text-[#555] tracking-wide">{e}</span>span>
                                                              ))}
                                                                        </div>div>
                                                        ...
                                                        <div className="text-right flex-shrink-0">
                                                                        <div className="font-serif text-[18px] font-light text-[#D4A017]">{b.price}</div>div>
                                                                        <a
                                                                                            href={WA(b.name)}
                                                                                            target="_blank"
                                                                                            rel="noopener noreferrer"
