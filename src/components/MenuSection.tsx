...
const ALMUERZOS = [
  ...
  },
  {
    ...
    price: '$22.000',
    featured: false,
    img: '/images/menu/almuerzo-arroz-carnes.jpg',
  },
  {
    ...
    price: '$25.000',
    featured: true,
    img: '/images/menu/menu-bandeja.jpg',
  },
]

const DESAYUNOS = [
  { name: 'Bandeja Asada Pechuga Cerdo', price: '$20.000', base: 'Precio base', extras: [],                           img: '/images/menu/almuerzo-bandeja-paisa.jpg' },
  { name: 'Ntanderea',                   price: '$30.000', base: 'Con bebida',  extras: ['Sin bebida −$3.000'],        img: '/images/menu/desayuno-caldo-huevo.jpg' },
  { name: 'Ntanderea Costilla',          price: '$33.000', base: 'Con bebida',  extras: ['Sin bebida −$3.000'],        img: '/images/hero-caldo-arepa.png' },
  { name: 'Caldo de Costilla',           price: '$18.000', base: 'Con bebida',  extras: ['Sin bebida −$2.000', '+ Huevos +$6.000'], img: '/images/hero-sancocho.png' },
  { name: 'Caldo de Huevo',             price: '$16.000', base: 'Con bebida',  extras: ['Sin bebida −$2.000', '+ Huevos +$6.000'], img: '/images/hero-caldo-arepa.png' },
  { name: 'Huevos al Gusto',            price: '$16.000', base: 'Con bebida',  extras: ['Sin bebida −$3.000'],        img: '/images/menu/almuerzo-fricasé.jpg' },
  { name: 'Bandeja de Carne',           price: '$18.000', base: 'Con bebida',  extras: [],                           img: '/images/plato-bandeja.png' },
  { name: 'Sandwich de Pollo',          price: '$18.000', base: 'Sin papa',    extras: ['+ Jugo +$4.000'],            img: '/images/menu/menu-pollo-plancha.jpg' },
  { name: 'Sandwich Jamón y Queso',     price: '$12.000', base: 'Sin papa',    extras: ['+ Jugo +$4.000'],            img: '/images/plato-hamburguesa.png' },
  { name: 'Huevos Pericos / Rancheros', price: '$10.000', base: 'Precio fijo', extras: [],                           img: '/images/plato-almuerzo.png' },
  { name: 'Arepa con Queso',            price: '$3.500',  base: 'Base',        extras: ['+ Jamón +$500'],             img: '/images/plato-bandeja.png' },
]
